...
export type SchedulerEnterprise = dhtmlxscheduler.SchedulerEnterprise;
export type SchedulerStatic = dhtmlxscheduler.SchedulerStatic;

declare module 'dhtmlxscheduler' {
    export namespace dhtmlxscheduler {
